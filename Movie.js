      ...
      <View style={styles.container}>
          ...
          >
            ...
            <View style={styles.rating}>
              {/* Value */}
              <Text style={[styles.text, styles.value]}>Released:{release_date}</Text>
            </View>
            {/* Plot */}
...
const styles = StyleSheet.create({
  ...
  container: {
    ...
    backgroundColor: '#156',            // Dark background
  },
  // Background image
  imageBackground: {
    flex: 1,                            // Take up all screen space
